return {
  ...
  [".env"]                       = { icon = "🔑", color = "#888888", cterm_color = "227", name = "Env"                      },
  ...
  ["go.mod"]                     = { icon = "📦", color = "#519ABA", cterm_color = "38",  name = "GoMod"                    },
  ["go.sum"]                     = { icon = "📦", color = "#519ABA", cterm_color = "38",  name = "GoSum"                    },
  ...
  ["package-lock.json"]          = { icon = "📦", color = "#CB3837", cterm_color = "52",  name = "PackageLockJson"          },
  ["package.json"]               = { icon = "📦", color = "#CB3837", cterm_color = "197", name = "PackageJson"              },
